          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-[#EF4444] text-sm text-center bg-[#EF4444]/10 p-3 rounded-lg border border-[#EF4444]/20"
              >
                {error}
              </motion.div>
            )}
            {success && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-secondary text-sm text-center bg-secondary/10 p-3 rounded-lg border border-secondary/20"
              >
                {success}
              </motion.div>
            )}
